...
/* function used to transform hal para to stm32l0 para */
/*int32_t timer_reload_mode_transform(uint8_t reload_mode_hal, uint8_t *reload_mode_stm32l0);*/
        ...
        uint8_t *reload_mode_stm32l0)
{
    ...
    if(ret == 0)
    {
        *reload_mode_stm32l0 = reload_mode;
    }
