...
//    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_7, GPIO_PIN_RESET);    
    ...
    /*Configure GPIO pins : PB10 PB11 PB12 PB13 */
    GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_12;//|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
//    
//    
//    GPIO_InitStruct.Pin &= ~(GPIO_PIN_1|GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_15);
