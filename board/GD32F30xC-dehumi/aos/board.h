...
#define PORT_UART_RFID   PORT_UART_AT
...
#define NETP_PORT_PWR_TRANS         0
#define NETP_PORT_PWR_485           1
#define NETP_PORT_PWR_PREPAY        2
#define NETP_PORT_PWR_RECHARGE      3
#define NETP_PORT_PWR_PRICE         4

#define NETP_PORT_PWR_VAVLE         5
...
#define LED_SWITCH1_NOR     GPIO_LED_SUB1_NORM
#define LED_SWITCH1_ERR     GPIO_LED_SUB1_ERR
