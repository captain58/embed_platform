...
typedef enum
{
    RFLR_STATE_IDLE,
    RFLR_STATE_RX_INIT,
    RFLR_STATE_RX_INITING,
    RFLR_STATE_RX_RUNNING,
    RFLR_STATE_RX_DONE,
    RFLR_STATE_RX_TIMEOUT,
    RFLR_STATE_TX_INIT,
    RFLR_STATE_TX_INITING,
...
BEHAVIOR Get_Current_Behave(uint32_t slot,uint32_t timeframe);
BEHAVIOR Get_Current_Behave2(uint32_t slot, uint32_t timeframe);
...
uint8_t Water_Disp_Pump(uint32_t tick);
