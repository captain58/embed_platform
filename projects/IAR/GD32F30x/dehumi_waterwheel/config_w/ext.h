...
#if (SYS_GPO_EN > 0)
    #define GPO_PORT_NUM    7
#endif

#if (SYS_LGPI_EN > 0)
    #define LGPI_PORT_NUM   14
    #define LGPI_GATE       4               //按键扫描门限
...
#define CON_PASSIVE_BUZZ_SOUND_0 0
#define CON_PASSIVE_BUZZ_SOUND_1 1
#define CON_PASSIVE_BUZZ_SOUND_2 2
#define CON_PASSIVE_BUZZ_SOUND_3 3
#define CON_PASSIVE_BUZZ_SOUND_4 4
#define CON_PASSIVE_BUZZ_SOUND_5 5
