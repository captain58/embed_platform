...
//	        uint32 Wp[4];                       //正向总\三分相有功电能示值  hex4.2  16 字节
//	        uint32 Wn[4];                       //反向总\三分相有功电能示值  hex4.2  16 字节
//	        uint16 U[9];                        //相电压                   hex2.4    18  字节
//	        uint16 I[9];                        //相电流                   hex4.3    18  字节
//	        int32 P[2];                        //总功率                    shex4.4  8 字节
        uint8_t dev;
