...
******************************************************************************/
    ...
    ******************************************************************************/
    const GPO_PORTS gs_LedPort[] = 
    {
        ...
        {(COMPORT*)&gs_BuzCard,     1, 0, 1},     //true:低电平点亮
        
        {(COMPORT*)&gs_LedNull,     0, 1, 1},     //true:低电平点亮
    };
        

    #define LED_NUM 7// (sizeof(gs_LedPort) / sizeof(GPO_PORTS))
...
******************************************************************************/
    ...
    ******************************************************************************/
    ...
    const COMPORT gs_GpiDIO2      = {(uint32_t)GPIOA, 6,  0, GPIO_MODE_INPUT,  GPIO_SPEED_FREQ_VERY_HIGH, GPIO_NOPULL,  0};//key2
