...
int at_send_no_reply(const char *data, int datalen, uint8 delimiter)
{
    int ret;
...
#if ATPSR_SINGLE_TASK
int at_send_wait_reply(const char *cmd, int cmdlen, uint8 delimiter,
