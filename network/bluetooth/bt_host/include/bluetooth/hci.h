...
//	#define BT_ADDR_LE_NONE (&(bt_addr_le_t) { 0, { { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff } } })
extern const bt_addr_le_t BT_ADDR_LE_ANY;// = { 0, { { 0, 0, 0, 0, 0, 0 } } };
extern const bt_addr_le_t BT_ADDR_LE_NONE;// = { 0, { { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff } } };
